...
public class Controller {
    ...
    /*
     * The Controller class is responsible for handling the interactions between the GUI components
     * and the underlying model of the hotel management system. It manages the navigation between
     * different views and updates the model based on user inputs.
     */
     ...
     * @param createHotel The create hotel view.
     * @param simulateBooking The simulate booking view.
     * @param manageHotel The manage hotel view.
     * @param viewHotel The view hotel view.
     * @param hotelOverview The hotel overview view.
     * @param roomAndReservation The room and reservation view.
     * @param model The underlying model of the hotel system.
     */
    public Controller(MainMenu mainMenu, CreateHotel createHotel, SimulateBooking simulateBooking, ManageHotel manageHotel, ViewHotel viewHotel, HotelOverview hotelOverview, RoomAndReservation roomAndReservation, HotelSystem model){
        ...
        this.roomAndReservation.getSelectRoomComboBoxReservation().addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e){
                int selectedIndex = viewHotel.getSelectHotelComboBox().getSelectedIndex();
                int selectedRoomIndex = roomAndReservation.getSelectRoomComboBoxReservation().getSelectedIndex();
                ...
                for(int i = 0; i < n; i++){
                    String guestName = model.getHotel().get(selectedIndex).getRoom(selectedRoomIndex).getReservation(i).getGuestName();
                    roomAndReservation.getSelectReservationComboBoxReservation().addItem(guestName);
                }
        ...
        this.manageHotel.getAddHotelRoomButton().addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e){
                ...
                Object[] rooms = {"Standard", "Deluxe", "Executive"};

                int n = JOptionPane.showOptionDialog(null,
                "Which Room do you like to add?",
                "Choose a room",
                ...
                if(n == 0){
                    ...
                    model.getHotel().get(selectedIndex).addDeluxeRoom(selectedHotel, numberOfRooms);
                } else if(n == 2){
                    model.getHotel().get(selectedIndex).addExecutiveRoom(selectedHotel, numberOfRooms);
                }
        ...
        this.manageHotel.getRemoveHotelRoomButton().addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e){
                int selectedIndex = manageHotel.getSelectHotelComboBox().getSelectedIndex();
                int selectedRoomIndex = manageHotel.getRemoveHotelRoomComboBox().getSelectedIndex();
                model.getHotel().get(selectedIndex).removeRoom(selectedRoomIndex);;
                manageHotel.getRemoveHotelRoomComboBox().removeItemAt(selectedRoomIndex);
                manageHotel.getRemoveReservationRoomComboBox().removeItemAt(selectedRoomIndex);
                manageHotel.getUpdateRoomPriceComboBox().removeItemAt(selectedRoomIndex);
            }
        });

        this.manageHotel.getRemoveReservationRoomComboBox().addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e){
        ...
        this.manageHotel.getRemoveReservationRoomButton().addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e){
    ...
    /*
     * this fills the selectHotelComboBox
     */
    ...
    /*
     * @param selectedIndex is the hotel that was selected in the selectComboBox of manageHotel
     */
    ...
    /*
     * @param selectedIndex is hotel that was selected for the simulate booking
     */
    ...
    /*
     * @param selectedHotelIndex is the selected hotel index
     * @param selectedRoomIndex is the selected room index
     */
    ...
    /*
     * fill the select check-in and check-out dates in the simulate booking 
     */
    ...
    /*
     * Fills the select checkdates for the room and reservation frame
     */
    ...
    /*
     * @param selectedIndex is the hotel index that was selected in the view hotel frame
     */
    ...
    /*
     * returns the days that are available as string
    ...
    /*
     * Fills the select room for the room comboBoxes for the romo and reservation frames
     * @param selectedIndex is the selected hotel in the view hotel frame
     */
    public void fillSelectRoomForView(int selectedIndex) {
        ...
        for(int i = 0; i < n; i++){
            roomAndReservation.getSelectRoomComboBoxRoom().insertItemAt(model.getHotel().get(selectedIndex).getRoom(i).getRoomName(), i);
            roomAndReservation.getSelectRoomComboBoxReservation().insertItemAt(model.getHotel().get(selectedIndex).getRoom(i).getRoomName(), i);
        }
    ...
    /*
     * This fills the text area in the tabbed panel that shows the information about the reservations and breakdown of prices
     */
    ...
    public void fillAvailDays(){
        int selectedIndex = viewHotel.getSelectHotelComboBox().getSelectedIndex();
        int selectedRoomIndex = roomAndReservation.getSelectRoomComboBoxRoom().getSelectedIndex();

        for (int x = 0; x < 31; x++){
            if (model.getHotel().get(selectedIndex).getRoom(selectedRoomIndex).getAvailableCheckInDays()[x] == true){
                roomAndReservation.getAvailComboBox().addItem(x);
            }
        }
    }
}
